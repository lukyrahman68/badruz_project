...
$(function() {
    ...
    // Media Lib lalala
    $('body').on('click', '*[data-type="medialib"]', function(){
        media_field = $(this).attr('data-field');
    });

    $('body').on('click','a#uploadButton',function(){
        currentUploadButton = $(this);
    });

    $("form").submit(function(e){
        $(this).find('.currency').each(function(d){
